...
import '../my_service/my_service_detail_page.dart';

class OpenApplicantsWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<OpenApplicantsWidget> createState() =>
      _OpenApplicantsWidgetState();
}

class _OpenApplicantsWidgetState extends ConsumerState<OpenApplicantsWidget> {
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text('Không có công việc nào đang mở.',
