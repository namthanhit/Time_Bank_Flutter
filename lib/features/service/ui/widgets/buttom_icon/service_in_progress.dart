...
class ServiceInProgressWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ServiceInProgressWidget> createState() =>
      _ServiceInProgressWidgetState();
}

class _ServiceInProgressWidgetState
    extends ConsumerState<ServiceInProgressWidget> {
