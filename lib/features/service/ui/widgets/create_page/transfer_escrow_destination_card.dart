...
class TransferEscrowDestinationCard extends ConsumerWidget {
  ...
  const TransferEscrowDestinationCard({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        ...
        _buildCalculationBox(baseDuration, slots),
  ...
  Widget _buildCalculationBox(Duration baseDuration, int slots) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Thời lượng: ${_formatDuration(baseDuration)}\nSố nhân sự: $slots',
            style: const TextStyle(
                fontSize: 18,
                color: const Color.fromARGB(255, 0, 62, 119),
  ...
  Widget _buildTimeBox(Duration amount, bool enough, bool attemptFailed) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Tổng thời gian cần chuyển',
              style: TextStyle(
                  color: Colors.black54,
                  fontSize: 15,
                  fontWeight: FontWeight.w500)),
